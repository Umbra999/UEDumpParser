...
struct ABP_large_mast_main_C : ABP_Mast_C {
	...
	void UserConstructionScript(); // Function BP_large_mast_main.BP_large_mast_main_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1848130
	void OnMastDescLoaded(struct UMastDescAsset* MastDesc); // Function BP_large_mast_main.BP_large_mast_main_C.OnMastDescLoaded // Event|Public|BlueprintEvent // @ game+0x1848130
	void ExecuteUbergraph_BP_large_mast_main(int32_t EntryPoint); // Function BP_large_mast_main.BP_large_mast_main_C.ExecuteUbergraph_BP_large_mast_main //  // @ game+0x1848130
};
